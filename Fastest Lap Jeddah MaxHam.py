########################################
# Base Packages and Data Quali Jeddah  #
########################################
...
# Load data
quali = ff1.get_session(2021, 'Jeddah', 'Q')
laps = quali.load_laps(with_telemetry=True)

########################################
# Fastest Lap Analysis: VER/HAM Jeddah #
########################################

# Import visaulization tools
...
telemetry = fastest_ham.append(fastest_ver)
